...
export const NetworkStatusWidget: React.FC<NetworkStatusWidgetProps> = ({ className = '' }) => {
  ...
  return (
    <div 
        ...
        className={`bg-white/80 dark:bg-black/80 backdrop-blur-3xl shadow-sm dark:shadow-2xl rounded-[2.5rem] p-8 flex flex-col justify-between h-full min-h-[220px] group relative overflow-hidden ${className}`}
    >
      {/* 1. Static Border */}
