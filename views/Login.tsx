        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-8">
            ...
            <div className="flex flex-col gap-3 text-center pt-2">
              ...
              <div className="pt-4 border-t border-gray-150 dark:border-zinc-800/40 mt-3">
                <button 
                  type="button"
                  onClick={() => onChangeView(AppView.ADMIN_LOGIN)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-dashed border-gray-300 dark:border-zinc-800 hover:border-primary-500 text-gray-500 dark:text-zinc-400 hover:text-primary-600 dark:hover:text-primary-400 font-extrabold text-sm bg-gray-50/50 dark:bg-white/[0.01] hover:bg-primary-50/30 dark:hover:bg-primary-500/5 transition-all cursor-pointer"
                >
